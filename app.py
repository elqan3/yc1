...
@app.route('/admin/members/accept/[int:applicant_id](int:applicant_id)')
@admin_required
...
@app.route('/admin/members/reject/[int:applicant_id](int:applicant_id)')
@admin_required
...
@app.route('/admin/news/delete/[int:news_id](int:news_id)')
@admin_required
...
@app.route('/admin/works/delete/[int:work_id](int:work_id)')
@admin_required
